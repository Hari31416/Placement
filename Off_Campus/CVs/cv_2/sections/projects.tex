...
\resumeItem{Trained \textbf{multiple models} using scikit-learn and selected the best one by applying \textbf{grid search} and \textbf{cross-validation}. Best regression model achieved a \textbf{top 12\%} ranking on the Kaggle leaderboard.}
\resumeItemListEnd{}
...
\resumeItemListStart{}
\resumeItem{Developed a very deep \textbf{convolutional neural network} using TensorFlow with \textbf{dropout} and \textbf{batch normalization} to improve performance achieving a test accuracy of \textbf{99.48\%}}
\resumeItemListEnd{}
